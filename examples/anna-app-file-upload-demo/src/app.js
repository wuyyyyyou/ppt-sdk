...
const I18N = {
  zh: {
    languageLabel: "语言",
    raceTitle: "2. 并发 invoke 关联验证",
    pathTitle: "3. 按本地路径上传文件",
    raceDescription: "并发执行多个独立 tools.invoke，并验证 negotiate 与 confirm 都携带各自的父 invoke ID。",
    concurrencyLabel: "并发数",
    totalCallsLabel: "总调用数",
    delayLabel: "confirm 前延迟",
    jitterLabel: "随机抖动",
    raceNote: "建议使用并发数 4 或 8。通过标准：归属错误为 0，下载日志中的 invoke_id 与 wire_invoke_id 一致。",
    startRace: "开始压测",
    stopRace: "停止调度",
    clearLogs: "清空日志",
  ...
  en: {
    ...
    raceTitle: "2. Concurrent invoke correlation check",
    pathTitle: "3. Upload a local file by path",
    raceDescription: "Run independent tools.invoke calls concurrently and verify that negotiate and confirm carry their own parent invoke IDs.",
    concurrencyLabel: "Concurrency",
    totalCallsLabel: "Total calls",
    delayLabel: "Delay before confirm",
    jitterLabel: "Random jitter",
    raceNote: "Use concurrency 4 or 8. Passing means zero ownership errors and matching invoke_id and wire_invoke_id values in the downloaded log.",

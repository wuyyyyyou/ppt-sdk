...
const defaultTableColumns: z.infer<typeof TableColumnSchema>[] = [
  { label: "Dimension", width: "1.08fr", align: "left", tone: "comparison" },
  { label: "Entity A", width: "0.9fr", align: "center", tone: "sideA" },
  { label: "Entity B", width: "0.9fr", align: "center", tone: "sideB" },
  { label: "Signal", width: "1.16fr", align: "left", tone: "comparison" },
];
...
const defaultTableRows: z.infer<typeof TableRowSchema>[] = [
  {
    cells: [
      ...
      { value: "High", tone: "sideA", emphasis: true, align: "center" },
      { value: "Focused", tone: "sideB", emphasis: true, align: "center" },
  ...
  },
  {
    cells: [
      ...
      { value: "Broad base", tone: "sideA", emphasis: false, align: "center" },
      { value: "Specialized", tone: "sideB", emphasis: false, align: "center" },
  ...
  },
  {
    cells: [
      ...
      { value: "Medium", tone: "comparison", emphasis: false, align: "center" },
      { value: "Medium", tone: "comparison", emphasis: false, align: "center" },

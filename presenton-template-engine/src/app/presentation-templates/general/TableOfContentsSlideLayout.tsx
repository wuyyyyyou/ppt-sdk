...
export const layoutTags = ['agenda', 'toc', 'outline']
export const layoutRole = 'agenda'
export const contentElements = ['numbered-list', 'outline']
export const useCases = ['agenda', 'table-of-contents', 'section-overview']
export const suitableFor = 'Suitable for agenda pages, section overviews, and chapter navigation pages.'
export const avoidFor = 'Avoid using this layout for free-form narrative text, charts, or pages that require rich visual comparison.'

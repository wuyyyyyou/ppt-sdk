...
const ExecutiveHeader = ({
  ...
  <div
    ...
    style={{ backgroundColor: chartAnalyticsTheme.colors.panel }}
  >
    <div className="min-w-0 flex-1">
      ...
      <h1 className="m-0 truncate text-[30px] font-bold leading-[1.15] text-white">{title}</h1>
    </div>
    ...
    <div className="flex flex-none items-center gap-[16px] pl-[28px]">
      <div className="text-right">
        ...
        <div className="mt-[3px] text-[14px] font-semibold text-white">{metaValue}</div>
      </div>
      <div

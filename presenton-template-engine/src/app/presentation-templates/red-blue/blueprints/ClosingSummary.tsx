...
export const Schema = z.object({
  title: z.string().min(2).max(52).default("Thank You"),
  subtitle: z.string().min(2).max(96).default("Questions and discussion"),
...
export const layoutTags = ["closing", "thank-you", "summary", "red-blue"];
...
export const suitableFor = "Suitable for thank-you pages, decision summaries, or final next steps.";
...
const ClosingSummary = ({ data }: { data: Partial<z.infer<typeof Schema>> }) => {
  ...
  return (
    <RedBlueCanvas showGrid={false} showDecorations={false}>
      ...
      <div className="absolute inset-x-[220px] top-[130px] bottom-[110px]">

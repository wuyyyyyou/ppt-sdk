...
const red_finance_v3Layouts: TemplateWithData[] = [
  ...
  createTemplateEntry(red_finance_v3_ThreeColumnCardsComponent, red_finance_v3_ThreeColumnCardsModule.Schema, red_finance_v3_ThreeColumnCardsModule.layoutId, red_finance_v3_ThreeColumnCardsModule.layoutName, red_finance_v3_ThreeColumnCardsModule.layoutDescription, "red-finance-v3", "ThreeColumnCards", {"sampleData":{"title":"Three Column Cards","metaLabel":"BLUEPRINT / THREE COLUMN","footerText":"Business Professional | Three Column Cards","pageNumber":"04","variant":"three-equal-columns","density":"medium","heading":"Parallel pillars","subtitle":"Three balanced columns for capabilities, strategies, issues, opportunities, or risks.","cards":[{"icon":"chart-column","title":"Structured expression","description":"Split peer-level ideas into columns instead of a long list.","tag":"structure"},{"icon":"shield","title":"Balanced density","description":"Keep each card focused on one short explanation.","tag":"balance"},{"icon":"route","title":"Easy extension","description":"Extend into more groups or split into follow-up slides.","tag":"extend"}],"summary":"Best for three parallel ideas; avoid using it for single-thread narratives or complex matrices."},"layoutTags":["three-column","cards","pillars","tsx-first"],"layoutRole":"content","contentElements":["heading","card-grid","summary"],"useCases":["categorization","pillars","options","recommendations"],"suitableFor":"Suitable for three-way groupings, parallel strategies, or compact capability clusters.","avoidFor":"Avoid using this layout for timelines, charts, or single-threaded explanations.","density":"medium","visualWeight":"balanced","editableTextPriority":"high"}),
  createTemplateEntry(red_finance_v3_ChartWithNarrativeComponent, red_finance_v3_ChartWithNarrativeModule.Schema, red_finance_v3_ChartWithNarrativeModule.layoutId, red_finance_v3_ChartWithNarrativeModule.layoutName, red_finance_v3_ChartWithNarrativeModule.layoutDescription, "red-finance-v3", "ChartWithNarrative", {"sampleData":{"title":"Chart With Narrative","metaLabel":"BLUEPRINT / CHART NARRATIVE","footerText":"Business Professional | Chart With Narrative","pageNumber":"05","variant":"chart-left-narrative-right","density":"medium","chartKind":"bar","chartTitle":"Trend and change","chartSubtitle":"One chart paired with one concise narrative.","labels":["Q1","Q2","Q3","Q4"],"series":[{"label":"Current","color":"var(--primary-color,#B71C1C)","values":[42,48,55,61]},{"label":"Target","color":"var(--secondary-color,var(--graph-1,#1565C0))","values":[40,45,50,58]}],"minValue":0,"maxValue":100,"ticks":[0,20,40,60,80,100],"narrativeTitle":"Interpretation points","narrativeItems":[{"icon":"lightbulb","title":"Change drivers","description":"Break key drivers into short points instead of crowding the chart."},{"icon":"shield","title":"Measurement note","description":"Keep definitions and conclusions editable beside the chart."},{"icon":"route","title":"Next step","description":"Use the conclusion to bridge into the next analysis or action."}],"summary":"Best for one primary chart with concise interpretation; avoid dashboard-style chart collections."},"layoutTags":["chart","narrative","evidence","tsx-first"],"layoutRole":"content","contentElements":["chart","narrative-list","summary"],"useCases":["trend","scale","structure-change","evidence"],"suitableFor":"Suitable for a single chart with short explanatory notes and a concise conclusion.","avoidFor":"Avoid using this layout for chart collections, dense matrices, or timeline-based storytelling.","density":"high","visualWeight":"balanced","editableTextPriority":"high"}),

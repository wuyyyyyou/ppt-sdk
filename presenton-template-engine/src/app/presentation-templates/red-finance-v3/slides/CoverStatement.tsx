...
export const Schema = z.object({
  ...
  reportTag: z.string().min(4).max(60).default("Blueprint-first Baseline"),
...
export const layoutDescription =
  "A blueprint-first finance cover slide with editable statement text, metadata, notes, and a reusable decorative finance visual.";
export const layoutTags = ["cover", "finance", "statement", "blueprint-first"];

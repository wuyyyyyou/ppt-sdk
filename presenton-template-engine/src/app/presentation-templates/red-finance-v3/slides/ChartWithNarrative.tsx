...
export const layoutDescription =
  "A blueprint-first slide that pairs one primary chart with compact narrative interpretation.";
export const layoutTags = ["chart", "narrative", "evidence", "blueprint-first"];

...
- Legacy context-row projection and Outline-owned output-language handling are removed from Outline Creation. Other downstream consumers may retain temporary Workspace-setting compatibility until their own stages are refactored.

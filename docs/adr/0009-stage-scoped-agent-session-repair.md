...
- Share one Agent session across an entire Page Generation Unit. Rejected because Research Curation, Page Authoring, Page Content Review, and Page Visual Review have different tool boundaries, grounding rules, and artifact ownership.

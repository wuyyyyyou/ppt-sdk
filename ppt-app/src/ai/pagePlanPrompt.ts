    ...
    messages: [
      {
        ...
        content: {
          ...
          text: [
            ...
            "Do not rewrite deck titles, page titles, or page outlines; copy them from the provided outline.",
      ...
      },
      {
        ...
        content: {
          ...
          text: [
            ...
            "- title must equal outline.title.",
            "- each pages[i].title must equal outline.items[i].title.",
            "- each pages[i].outline must equal outline.items[i].outline.",
            ...
            "- Do not add unsupported facts or details.",
          ].join("\n"),
        },
      },
    ],

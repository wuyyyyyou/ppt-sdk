...
function persistentElementsPrompt(input: RunDeckGenerationInput, targetPath: string, previousError = "") {
  return [
    ...
    `目标文件：${targetPath}`,
    "将目标文件改写为完整、可编译、可独立渲染的 1280×720 TSX 参考页。它只规定页眉、页脚、页码、持续装饰和内容安全区域，不规定正文布局。",
    "艺术指导负责整套视觉意图；本文件负责固定元素的具体 JSX 结构、位置、字体、字号、颜色和间距。",
    "如果本 Deck 不需要固定元素，也必须改写成明确的空参考（JSX 注释说明 No persistent elements），不能原样保留 Bootstrap。",

...
export function buildAuthoringPrompt(input: {
  ...
  return [
    ...
    [
      ...
      "- Use only content promoted into Research Evidence. Do not read or use raw research files or raw uploaded source files by default.",
      "- Image text, chart labels, and visual-only material are not factual grounding unless the same fact is separately listed under ## Facts.",
...
export function buildPageContentReviewPrompt(input: {
  ...
  return [
    ...
    pageRefinementRequest
      ? "- Evidence sources: user prompt, context rows, task_context, Confirmed Outline source prompt/context/task_context, Confirmed Outline text, current-page Research Evidence, explicitly marked Shared Research Evidence inside the current-page evidence markdown, current Page Refinement Request facts explicitly stated below, and the current Page Plan title/outline/reason/content_plan only when they restate or derive from the Confirmed Outline or assigned Research Evidence."
      : "- Evidence sources: user prompt, context rows, task_context, Confirmed Outline source prompt/context/task_context, Confirmed Outline text, current-page Research Evidence, explicitly marked Shared Research Evidence inside the current-page evidence markdown, and the current Page Plan title/outline/reason/content_plan only when they restate or derive from the Confirmed Outline or assigned Research Evidence.",
    "- Uploaded-source-derived claims are grounded only when they trace to current-page Research Evidence / Visual Assets. Raw uploaded files and full Uploaded Source Analysis are not evidence sources.",
    "- Image text, chart labels, and visual-only material are not factual evidence unless separately listed under current-page Research Evidence Facts.",
    "- Not evidence sources: current page data JSON, current page slide TSX, Raw Research Material, raw Uploaded Source Material files, full Uploaded Source Analysis, Research Discovery Evidence Pool, research/evidence-index.json, stale Research Evidence, other pages' Research Evidence, rendered HTML, screenshots, generated pages, generated slide data, Agent summaries, visual review output, or any content created during the current page authoring run.",

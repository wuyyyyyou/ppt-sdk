...
const toneDefaults = (tone: HorizontalFeatureCardTone) => {
  switch (tone) {
    case "accent":
      return {
        railColor: theme.colors.accent,
        iconBackgroundColor: theme.colors.accentSoft,
        iconStroke: theme.colors.accent,
        tagBorderColor: theme.colors.accentBorder,
        tagBackgroundColor: theme.colors.accentTint,
        tagTextColor: theme.colors.accent,
      };
    case "future":
      return {
        railColor: theme.colors.accent,
    ...
    default:
      return {
        railColor: theme.colors.iconMuted,
        iconBackgroundColor: theme.colors.accentSoft,
        iconStroke: theme.colors.accent,
        tagBorderColor: theme.colors.stroke,
        tagBackgroundColor: theme.colors.panel,
        tagTextColor: theme.colors.textMuted,
      };
  }
};
  ...
  return (
    <div
      ...
      style={{
        ...
        borderColor: borderColor ?? theme.colors.stroke,
        backgroundColor: cardBackgroundColor ?? theme.colors.canvas,
        boxShadow: shadow ?? theme.shadows.card,
      }}
    >
      {railSide === "left" ? (
        <div
        ...
        >
          ...
          <div
            style={{
              ...
              color: descriptionColor ?? theme.colors.textMuted,
            }}
          >
            {description}
          </div>

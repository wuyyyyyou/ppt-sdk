...
const StableMatrixGrid = ({
  ...
  rows,
  density = "normal",
  outerBorderColor = theme.colors.strokeSoft,
  headerBackgroundColor = theme.colors.accent,
  headerTextColor = theme.colors.accentText,
  rowDividerColor = theme.colors.stroke,
  stripeColors = [theme.colors.surface, theme.colors.panel],
  rowHeaderBackgroundColor = theme.colors.surface,
                  ...
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor:
                        ...
                        (tone === "accent" ? theme.colors.rowAccent : baseRowBackground),
                      borderTop: rowBorderTop,
                    }}
                  >
                    <div

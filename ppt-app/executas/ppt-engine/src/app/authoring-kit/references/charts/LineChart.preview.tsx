  ...
  return (
    <SlideCanvas style={{ background: "#f4f5f7", fontFamily: "Arial, sans-serif" }}>
      <div style={{ position: "absolute", left: 150, top: 90, width: 980, height: 540, padding: 28, background: "#fff", borderRadius: 16 }}>
        ...
        <LineChartReference unit="分" labels={["阶段一", "阶段二", "阶段三", "阶段四"]} series={[{ label: "示例方案 A", values: [18, 26, 34, 42] }, { label: "示例方案 B", values: [14, 22, 29, 38] }]} minValue={0} maxValue={50} ticks={[0, 10, 20, 30, 40, 50]} width={920} height={440} />
      </div>
    </SlideCanvas>
  );
}

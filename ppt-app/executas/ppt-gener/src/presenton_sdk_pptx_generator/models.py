...
class PptxSpacingModel(BaseModel):
    ...
    @classmethod
    def all(cls, num: int) -> "PptxSpacingModel":
        return cls(top=num, left=num, bottom=num, right=num)
...
class PptxPositionModel(BaseModel):
    ...
    @classmethod
    def for_textbox(cls, left: int, top: int, width: int) -> "PptxPositionModel":
...
class PptxParagraphModel(BaseModel):
    ...
    @classmethod
    def convert_alignment_enum(cls, value):
        if value is None or isinstance(value, PP_ALIGN):
            return value
...
class PptxTextBoxModel(PptxShapeModel):
    ...
    @classmethod
    def convert_vertical_alignment_enum(cls, value):
        if value is None or isinstance(value, MSO_ANCHOR):
            return value
        return MSO_ANCHOR(value)
...
class PptxAutoShapeBoxModel(PptxShapeModel):
    ...
    @classmethod
    def convert_shape_type_enum(cls, value):
        if value is None or isinstance(value, MSO_AUTO_SHAPE_TYPE):
            return value
        return MSO_AUTO_SHAPE_TYPE(value)
    ...
    @classmethod
    def convert_border_radius_to_int(cls, value):
        if value is None:
            return None
...
class PptxPictureBoxModel(PptxShapeModel):
    ...
    @field_validator("border_radius", mode="before")
    @classmethod
    def convert_border_radius_list_to_int(cls, value):
        if value is None:
            return None
...
class PptxConnectorModel(PptxShapeModel):
    ...
    @field_validator("type", mode="before")
    @classmethod
    def convert_connector_type_enum(cls, value):
        if value is None or isinstance(value, MSO_CONNECTOR_TYPE):
            return value
        return MSO_CONNECTOR_TYPE(value)
